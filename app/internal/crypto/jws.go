...
type JWSHeader struct {
	...
	// KeyID is used to look up the public key in the receiver's key manager.
	//
	// Keys generated by the keygen CLI tool that comes with this implementation
	// use the JWK thumbprint of the public key as the key ID
