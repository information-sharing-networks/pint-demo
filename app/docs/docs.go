        ...
        "/v3/envelopes/{envelopeReference}/additional-documents/{documentChecksum}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Base64-encoded document content (json string)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
